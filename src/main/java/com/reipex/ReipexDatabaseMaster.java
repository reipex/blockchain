 ...
 */
public class ReipexDatabaseMaster {
    ...
    /**
     * Constructor for ReipexDatabaseMaster reads in blockchain data, and writes the first two blocks of the network to a file if necessary.
     */
    public ReipexDatabaseMaster(String dbFolder) {
    ...
    /**
     * Returns the balance of an address on the network. Does not include unconfirmed balances.
     *
    ...
    /**
     * Returns the signature index of an address on the network. Does not account for previous signatures; only blockchain info.
     *
