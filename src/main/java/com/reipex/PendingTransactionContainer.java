 ...
 * It could be just an ArrayList<String> inside of Main, however it seemed easier and more OOP-ish to give it its own object.
...
public class PendingTransactionContainer {
    ...
    private ReipexDatabaseMaster databaseMaster;
     ...
     */
    public PendingTransactionContainer(ReipexDatabaseMaster databaseMaster) {
     ...
     * in a network block, all in one call. The returned boolean is not currently utilized in Main, proper handling of blocks with transaction issues will be addressed
     * in a future
     *
    ...
    public boolean removeTransactionsInBlock(String rawBlock) {
        ...
        try {
            ...
            List<String> transactions = tempBlock.getTransactions();
     ...
     *
     * @param address address to search the pending transaction pool for
