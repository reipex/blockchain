...
public class TransactionUtility {
    ...
    /**
     * Transactions on the network from the same address must occur in a certain order, dictated by the signature index.
     ...
     * @return String The full transaction, formatted for use in the network, including the signature and signature index. Returns null if transaction is incorrect for any reason.
     */
