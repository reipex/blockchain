...
public class MerkleAddressUtility {
    ...
    public boolean verifyMerkleSignature(String message, String signature, String address, long index) {
        try {
            ...
            //Lamport Signatures sign the first 100 bytes of the hash. To generate a message colliding with the signature, one would need on average 2^99 tries
     ...
     *
     * @param privateKey The original private key of the address in question
     ...
     * address format: Prefix + TreeRoot + VerificationHash
