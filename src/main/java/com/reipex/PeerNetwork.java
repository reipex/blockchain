...
/**
 * This thread listens on a provided port (8015 by default) for incoming connections, and attempts to make connections to external peers based on guidance from Main.
 * It needs a bit of help with memory management and resource deallocation, but otherwise it works.
 * <p>
