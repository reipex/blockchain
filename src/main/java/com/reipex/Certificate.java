    ...
    public String getMinCertificateScoreWithNonce() {
        ...
        try {
            ...
            for (int i = 0; i < maxNonce; i++) {
                 ...
                 * For this reason, it's incredibly safe to discard all negative numbers. If the network difficulty is so easy that a Long represented in binary
                 ...
                 * minutes, with only ONE allowed nonce (0) for the difficulty to drop this low. By everyone. At the same time.
