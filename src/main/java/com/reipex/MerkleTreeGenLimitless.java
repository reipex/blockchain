...
/**
 * This class is used to generate Merkle Trees from private keys. The top of the generated Merkle Tree is the address of the tree.
    ...
    public String generateMerkleTreeFromScratchFile(String scratchFileName, int numLayers) {
        try {
            ...
            if (!addressFile.exists()) {
                ...
                infoFileWriter.println("software_version: 0.1");
